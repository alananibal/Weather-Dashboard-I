...
function addResult(){
    ...
    if (searchedCities.includes(inputCity) === false){
        ...
        .then(function (data) {
          ...
          .then(function (data) {
            ...
            for (var i=1;i<6;i++){
                ...
                $(".five-day").append(miniCards)
                miniCards.append((this["futureDate"+i]));
                miniCards.append((this["futureIcon"+i]));
                miniCards.append((this["futureTemp"+i]));
                miniCards.append((this["futureWind"+i]));
                miniCards.append((this["futureHumidity"+i]));

                miniCards.addClass("weather-card")
            }
...
function loadCities () {
    ...
    for (var i = 0; i < searchedCities.length; i++) {
        var inputCity = searchedCities[i];
        var searchCity =$("<div>") 
        searchCity.attr('id',inputCity) 
        searchCity.text(inputCity) 
        searchCity.addClass("h4")
